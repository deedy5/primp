...
//!
//! Conversely, the functionality in `primp::blocking` must *not* be executed
...
//! [`primp::Client`][crate::Client] instead. If the immediate context is only
...
//!
//! ```rust
//! # use primp::{Error, Response};
//!
//! # fn run() -> Result<(), Error> {
//! let body = primp::blocking::get("https://www.rust-lang.org")?
//!     .text()?;
//!
//! println!("body = {body:?}");
//! # Ok(())
...
//! Reader, you can use the `primp::blocking::Body::new()` constructor.
//!
//! ```rust
//! # use primp::Error;
//! #
