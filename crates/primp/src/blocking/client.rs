...
/// use std::time::Duration;
///
/// let client = primp::blocking::Client::builder()
...
impl ClientBuilder {
    ...
    /// [`primp::blocking`][crate::blocking] for details.
    ...
    /// ```rust
    /// use primp::header;
    /// # fn build_client() -> Result<(), primp::Error> {
    ...
    /// let cert = primp::Certificate::from_der(&der)?;
    ///
    /// // get a client builder
    /// let client = primp::blocking::Client::builder()
...
impl Client {
    ...
    /// on [`primp::blocking`][crate::blocking] for details.
    pub fn new() -> Client {
    ...
    pub fn headers(&mut self) -> &mut header::HeaderMap {
        self.inner.headers()
    }

    /// Set proxies for the client.
    pub fn proxies(&mut self, proxies: Vec<Proxy>) {
...
impl ClientHandle {
    ...
    fn headers(&mut self) -> &mut header::HeaderMap {
        &mut self.headers
    }

    fn proxies(&mut self, proxies: Vec<Proxy>) {
        self.proxies = proxies;
    }

    #[cfg(feature = "cookies")]
    fn get_cookies(&self, _url: &url::Url) -> Option<HeaderValue> {
        // Cookie access not implemented in blocking client
        None
    }

    #[cfg(feature = "cookies")]
    fn set_cookies(&self, _url: &url::Url, _cookies: Vec<HeaderValue>) {
        // Cookie setting not implemented in blocking client
    }
