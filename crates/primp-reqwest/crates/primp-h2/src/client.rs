...
pub struct Builder {
    ...
    headers_stream_dependency: Option<crate::frame::StreamDependency>,

    /// Priority stream list
    priorities: Option<crate::frame::Priorities>,
}
...
impl Builder {
    ...
    /// Sets the stream dependency and weight for outgoing HEADERS frames.
    ///
    /// This configures the priority of a stream by specifying its dependency and weight,
    ...
    pub fn headers_stream_dependency(
        &mut self,
        stream_dependency: crate::frame::StreamDependency,
    ) -> &mut Self {
    ...
    pub fn priorities(&mut self, priorities: crate::frame::Priorities) -> &mut Self {
