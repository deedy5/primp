...
# Set the proxy via environment variable before running this script:
#   export PRIMP_PROXY="http://127.0.0.1:8080"  (Linux/macOS)
#   set PRIMP_PROXY=http://127.0.0.1:8080       (Windows CMD)
#   $env:PRIMP_PROXY="http://127.0.0.1:8080"    (Windows PowerShell)
client = primp.Client()
resp = client.get("https://httpbin.org/ip")
